<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="CDSWebConfig.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        输入你的用户名和密码，点击
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false">这里</asp:HyperLink> 添加一个新用户。
    </p>
