...
namespace CDSWebConfig.DB
{
    public abstract class OracleHelper
    {
        ...
        /// <param name="commandParameters">an array of OracleParamters used to execute the command</param>
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static bool ExecuteNonQuery(OracleTransaction trans, CommandType cmdType, List<string> cmdTextList, List<OracleParameter[]> commandParametersList)
        {
            int val = 0;
            bool success = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                ...
                for (int i = 0; i < cmdTextList.Count; i++)
                {
                    ...
                    OracleParameter[] commandParameters = commandParametersList[i];
                    PrepareCommand(cmd, trans.Connection, trans, cmdType, cmdText, commandParameters);
        ...
        /// <param name="commandParameters">an array of OracleParamters used to execute the command</param>
        /// <returns></returns>
        public static DataSet ExecuteDataset(OracleConnection conn, CommandType cmdType, string cmdText, params OracleParameter[] commandParameters)
        {
